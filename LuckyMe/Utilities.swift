...
extension MainView {
    ...
    func alderKlasse(){
        ...
        if kjonn == "F" {
            ...
            if fAar < 3 {kjonn = "Jente"; bilde = "f2"
            } else if fAar < 6  {kjonn = "Jente"; bilde = "f5"
            } else if fAar < 8  {kjonn = "Jente"; bilde = "f7"
            } else if fAar == 8  {kjonn = "Jente"; bilde = "f8"
            } else if fAar < 11  {kjonn = "Jente"; bilde = "f9"
            } else if fAar < 13 {kjonn = "Ung Jente"; bilde = "f12"
            } else if fAar < 15 {kjonn = "Tennåring Jente"; bilde = "f14"
            } else if fAar == 15 {kjonn = "Tennåring Jente"; bilde = "f15"
            } else if fAar == 16 {kjonn = "Tennåring Jente"; bilde = "f16"
            } else if fAar < 19 {kjonn = "Tennåring Jente"; bilde = "f18"
            } else if fAar == 19 {kjonn = "Tennåring Jente"; bilde = "f19"
            } else if fAar < 24 {kjonn = "Ung Dame"; bilde = "f22"
            } else if fAar < 29 {kjonn = "Ung Dame"; bilde = "f25"
            } else if fAar < 36 {kjonn = "Ung Dame"; bilde = "f35"
            } else if fAar < 41 {kjonn = "Ung Dame"; bilde = "f40"
            } else if fAar < 45 {kjonn = "Voksen Dame"; bilde = "f44"
            } else if fAar < 51 {kjonn = "Voksen Dame"; bilde = "f45"
            } else if fAar < 55 {kjonn = "Voksen Dame"; bilde = "f50"
            } else if fAar >= 55 {kjonn = "Gammel Kjærring"; bilde = "f55"
            }
        } else if kjonn == "M"{
            if fAar < 3 {kjonn = "Gutt"; bilde = "m2"
            } else if fAar < 6  {kjonn = "Liten Gutt"; bilde = "m3"
            } else if fAar < 8 {kjonn = "Ung Gutt"; bilde = "m7"
            } else if fAar < 11 {kjonn = "Ung Gutt"; bilde = "m8"
            } else if fAar < 13  {kjonn = "Ung Gutt"; bilde = "m12"
            } else if fAar < 15  {kjonn = "Tennåring Gutt"; bilde = "m13"
            } else if fAar < 20  {kjonn = "Tennåring Gutt"; bilde = "m19"
            } else if fAar == 20  {kjonn = "Mann"; bilde = "m20"
            } else if fAar < 26  {kjonn = "Mann"; bilde = "m21"
            } else if fAar < 35  {kjonn = "Mann"; bilde = "m29"
            } else if fAar < 46  {kjonn = "Mann"; bilde = "m35"
            } else if fAar < 56  {kjonn = "Voksen Mann"; bilde = "m45"
            } else if fAar >= 55 {kjonn = "Gammel Gubbe"; bilde = "m55"
            }
        }
    }
